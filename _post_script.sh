...
curl $CURL_VERBOSITY --fail --retry 3 --retry-delay 5 --connect-timeout 10 --output _codestation_script.sh https://pipeline-artifact-repository-service.us-east.devops.cloud.ibm.com:443/v3/up.sh
if [ $? == 0 ]; then
export PIPELINE_CODESTATION_URL='https://pipeline-artifact-repository-service.us-east.devops.cloud.ibm.com:443'
export PIPELINE_ARCHIVE_ID=''
export PIPELINE_ARCHIVE_TOKEN='7e2708cc35d7470ab030c6829989b843.3bb3592c2af5afd5da17881e90356563ce47315b06c3a0c8cc4c3eb83f5d1e2d.abf62b982761ac7c85a58254f2d01d3ac1937600'
   sh _codestation_script.sh
else
   echo "An error occurred while attempting to download https://pipeline-artifact-repository-service.us-east.devops.cloud.ibm.com:443/v3/up.sh"
   exit 1
fi
if [ "$PIPELINE_DEBUG_SCRIPT" == "true" ]; then
